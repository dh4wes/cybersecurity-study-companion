...
Today you are learning how Exposure fit into google course 5: assets, threats, and vulnerabilities (part 1), so the topic feels like a system instead of a vocabulary list.
