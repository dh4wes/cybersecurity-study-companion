...
Today you are learning how Evidence Handling fit into google course 6: detection and response (part 2), so the topic feels like a system instead of a vocabulary list.
