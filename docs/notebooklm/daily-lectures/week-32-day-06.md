...
session_type: "Review"
title: "Weekly synthesis: Spaced Repetition, Retrieval Practice, Mock Exam"
...
glossary_terms: ["Spaced Repetition","Retrieval Practice","Mock Exam","Error Log","Knowledge Gap","Study-System Reset"]
glossary_ids: ["spaced-repetition","retrieval-practice","mock-exam","error-log","knowledge-gap","study-system-reset"]
flashcard_ids: ["spaced-repetition-definition","spaced-repetition-mechanism","spaced-repetition-scenario","retrieval-practice-definition","retrieval-practice-mechanism","retrieval-practice-scenario","mock-exam-definition","mock-exam-mechanism","mock-exam-scenario","error-log-definition","error-log-mechanism","error-log-scenario","knowledge-gap-definition","knowledge-gap-mechanism","knowledge-gap-scenario","study-system-reset-definition","study-system-reset-mechanism","study-system-reset-scenario"]
estimated_read_minutes: 5
---

# Weekly synthesis: Spaced Repetition, Retrieval Practice, Mock Exam
...
## 2. Mini lecture
This is a synthesis day, which means the goal is retrieval, connection, and cleanup rather than adding a fresh topic. The week's focus was Catch-up, comprehensive review, and study-system reset, and the real question now is whether the concepts from earlier study days fit together as one working model. You should be able to move from term names such as Spaced Repetition, Retrieval Practice, Mock Exam, Error Log, Knowledge Gap, and Study-System Reset to the underlying system behavior without rereading every resource from scratch.

Start by reconstructing the week from memory. Explain the week's deliverable, the checkpoint, and the sequence of ideas that led there. Then test whether you can connect mechanism to purpose: Spaced Repetition: schedules reviews at increasing intervals, bringing material back near the point it would otherwise be forgotten Retrieval Practice: forces recall from memory first, then checks the answer so weak traces are strengthened through correction Mock Exam: simulates test conditions, measures performance under time limits, and reveals weak domains before the real exam Error Log: captures failed questions or mistakes, records why they happened, and turns them into targeted review items If one term only makes sense in isolation, that is the weak spot to revisit. Review days are for rebuilding those bridges before they become exam traps.
