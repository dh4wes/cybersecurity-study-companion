...
- CVSS vs Risk Assessment — CVSS: Common Vulnerability Scoring System for rating vulnerability severity. Risk Assessment: Structured evaluation of risk likelihood, impact, and treatment options.
- Purpose vs mechanism — be able to separate what CVSS is for from how it actually performs that job.
...
Use a pipeline model for this day: input arrives, a component or service processes it, state changes occur, and an output or symptom becomes visible to the user, administrator, or analyst. CVSS: scores vulnerabilities by combining exploitability and impact metrics into a standardized severity value If you can narrate that path from start to finish without skipping the middle, the topic is becoming operational instead of abstract.

## 6. If you can explain this, you understand it
- Describe what CVSS does, what input it works on, and what evidence would show that it is functioning correctly.
